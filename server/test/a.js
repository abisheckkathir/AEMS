...
//                      var jsondata = {idno:'chairrtest3',password:'123456789', userType:'chair'}
//                      request.post({url: baseurl + '/api/auth/signin-chair', body: jsondata,headers: {'content-type' : 'application/json'},json: true},
//                      function(error, response, body){
...
//         request.post({url: baseurl + '/api/auth/reject-assign/studenttest2Course7test2python3', headers: {'content-type' : 'application/json'},json: true},
